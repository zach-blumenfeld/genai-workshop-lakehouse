...
into Neo4j**. neocarta reads its *metadata* (the foreign-key join paths) to build
the connections shape; the finale federates against the live rows. This folder
provisions it.
