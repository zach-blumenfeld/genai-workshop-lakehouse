...
CYPHER = """
// ================================================== BUILD FROM SPEC =====
// Call db.index.fulltext.queryNodes('content_search', $lucene), keep rows
// where $under IS NULL OR node.uri STARTS WITH $under (the index ranks,
// the graph scopes), and return: label ('Document'|'Section'), uri,
// displayName, a 140-char content preview, score - top $k by score.
RETURN '' AS label, '' AS uri, '' AS displayName, '' AS preview, 0.0 AS score
// =========================================================================
"""
