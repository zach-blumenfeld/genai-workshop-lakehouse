"""Canonical AutoFix dataset definitions.

Single source of truth for generated PDF + warehouse sources.
Mirrors asciidoc/courses/genai-workshop-lakehouse/data/generate.py in the
courses repo - keep in sync if the story changes.
"""
